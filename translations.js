...
const translations = {
  en: {
    ...
    lessonReady: "Lesson ready to start!",
        reviewModeReady: "Review mode - Click lines to hear audio, or click Reset to practice again",
    ...
    lessonCompleteReview: "Lesson Complete - Click any line to hear audio",
    reviewModeReady: "Review Mode Ready - Click Reset to restart lesson or click any line to hear audio",
  ...
  es: {
    ...
    lessonCompleteReview: "Lección Completa - Haz clic en cualquier línea para escuchar el audio",
    reviewModeReady: "Modo Revisión Listo - Haz clic en Reiniciar para recomenzar la lección o en cualquier línea para escuchar audio",
  ...
  fr: {
    ...
    lessonCompleteReview: "Leçon Terminée - Cliquez sur n'importe quelle ligne pour entendre l'audio",
    reviewModeReady: "Mode Révision Prêt - Cliquez sur Redémarrer pour recommencer la leçon ou sur n'importe quelle ligne pour entendre l'audio",
  ...
  de: {
    ...
    lessonCompleteReview: "Lektion Abgeschlossen - Klicken Sie auf eine beliebige Zeile, um Audio zu hören",
    reviewModeReady: "Überprüfungsmodus Bereit - Klicken Sie auf Zurücksetzen, um die Lektion neu zu starten, oder auf eine beliebige Zeile, um Audio zu hören",
  ...
  it: {
    ...
    lessonCompleteReview: "Lezione Completata - Clicca su qualsiasi riga per sentire l'audio",
    reviewModeReady: "Modalità Revisione Pronta - Clicca su Riavvia per ricominciare la lezione o su qualsiasi riga per sentire l'audio",
  ...
  zh: {
    ...
    reviewMode: "复习模式",
    lessonCompleteReview: "课程完成 - 点击任意行听音频",
    reviewModeReady: "复习模式就绪 - 点击重置重新开始课程或点击任意行听音频",
    vocabQuiz: "词汇测验",
  ...
  ja: {
    ...
    reviewMode: "復習モード",
    lessonCompleteReview: "レッスン完了 - 任意の行をクリックして音声を聞く",
    reviewModeReady: "復習モード準備完了 - リセットをクリックしてレッスンを再開するか、任意の行をクリックして音声を聞く",
    vocabQuiz: "語彙クイズ",
  ...
  ko: {
    ...
    reviewMode: "복습 모드",
    lessonCompleteReview: "수업 완료 - 아무 줄이나 클릭하여 오디오 듣기",
    reviewModeReady: "복습 모드 준비 완료 - 리셋을 클릭하여 수업을 다시 시작하거나 아무 줄이나 클릭하여 오디오 듣기",
    vocabQuiz: "어휘 퀴즈",
