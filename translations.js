...
const translations = {
  en: {
    ...
    errorLoadingExplanation: "Error Loading Explanation",
    explanationLoadFailed: "Failed to load explanation. Please try again.",
  ...
  es: {
    ...
    errorLoadingExplanation: "Error al Cargar Explicación",
    explanationLoadFailed: "Error al cargar la explicación. Por favor inténtalo de nuevo.",
  ...
  fr: {
    ...
    errorLoadingExplanation: "Erreur de Chargement de l'Explication",
    explanationLoadFailed: "Échec du chargement de l'explication. Veuillez réessayer.",
  ...
  de: {
    ...
    errorLoadingExplanation: "Fehler beim Laden der Erklärung",
    explanationLoadFailed: "Laden der Erklärung fehlgeschlagen. Bitte versuchen Sie es erneut.",
  ...
  it: {
    ...
    errorLoadingExplanation: "Errore nel Caricamento della Spiegazione",
    explanationLoadFailed: "Caricamento della spiegazione fallito. Riprova.",
  ...
  zh: {
    ...
    errorLoadingExplanation: "加载解释时出错",
    explanationLoadFailed: "加载解释失败。请重试。",
    closeTutorial: "关闭教程", 
  ...
  ja: {
    ...
    errorLoadingExplanation: "説明の読み込みエラー",
    explanationLoadFailed: "説明の読み込みに失敗しました。再試行してください。",
  ...
  ko: {
    ...
    explanation: "설명",
    playingPhrase: "재생 중",
    loadingExplanation: "설명 로딩 중...",
    errorLoadingExplanation: "설명 로딩 오류",
    explanationLoadFailed: "설명 로딩에 실패했습니다. 다시 시도해주세요.",
